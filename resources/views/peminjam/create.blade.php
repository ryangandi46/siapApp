...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="container" id="tambah-edit-form">
            ...
            <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal" action="{{ route('peminjaman.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kelas" id="kelas" class="form-control" placeholder="Kelas" value="" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="jumlah" id="jumlah" class="form-control" placeholder="Jumlah" value="" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" name="waktu_meminjam" id="waktu_meminjam" class="form-control" placeholder="Waktu Meminjam" value="" required>
                        </div>
